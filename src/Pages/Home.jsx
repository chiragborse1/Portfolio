...
const WORDS = ["Media & IT Student", "Tech Enthusiast"];
const TECH_STACK = ["React", "Javascript", "Node.js"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/chiragborse1" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/chirag-borse/" },
  { icon: Instagram, link: "https://www.instagram.com/_mechirag_/" },
];
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p
                  ...
                  data-aos-delay="1000"
                >
                  Developer skilled in frontend, backend, databases, and creating smooth user experiences.
                </p>
            ...
            >
              <div className="relative w-full opacity-90">
                ...
                >
                  ...
                  {/* Coding GIF from public folder */}
                  <img
                    src="/Coding.gif"
                    alt="Coding animation"
                    className="absolute bottom-4 right-4 w-36 h-36 object-contain rounded-lg shadow-2xl hidden sm:block"
                  />
                </div>
